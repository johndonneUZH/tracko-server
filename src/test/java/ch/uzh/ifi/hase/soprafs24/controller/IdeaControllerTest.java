...
public class IdeaControllerTest {
    ...
    public void createIdea_success() throws Exception {
        ...
        createdIdea.setCreatedAt(LocalDateTime.now());
        createdIdea.setUpdatedAt(LocalDateTime.now());
        createdIdea.setIdeaStatus(IdeaStatus.OPEN);
        createdIdea.setUpVotes(0L);
        createdIdea.setDownVotes(0L);
        createdIdea.setSubIdeas(new ArrayList<>());
        ...
        mockMvc.perform(post("/projects/{projectId}/ideas", PROJECT_ID)
                ...
                .andExpect(jsonPath("$.ideaStatus").value("OPEN"))
    ...
    public void getIdeaById_success() throws Exception {
        ...
        idea.setIdeaStatus(IdeaStatus.OPEN);
        idea.setUpVotes(5L);
        idea.setDownVotes(2L);
        idea.setSubIdeas(Arrays.asList("sub-idea-1"));
        ...
        mockMvc.perform(get("/projects/{projectId}/ideas/{ideaId}", PROJECT_ID, IDEA_ID)
                ...
                .andExpect(jsonPath("$.subIdeas[0]").value("sub-idea-1"));
    }
    ...
    public void updateIdea_success() throws Exception {
        ...
        ideaUpdate.setSubIdeas(Arrays.asList("sub-idea-1"));
        ...
        updatedIdea.setIdeaStatus(IdeaStatus.CLOSED);
        updatedIdea.setUpVotes(5L);
        updatedIdea.setDownVotes(2L);
        updatedIdea.setSubIdeas(Arrays.asList("sub-idea-1"));
        ...
        mockMvc.perform(put("/projects/{projectId}/ideas/{ideaId}", PROJECT_ID, IDEA_ID)
                ...
                .andExpect(jsonPath("$.projectId").value(PROJECT_ID))
                .andExpect(jsonPath("$.ideaStatus").value("CLOSED"))
                .andExpect(jsonPath("$.upVotes").value(5))
                .andExpect(jsonPath("$.downVotes").value(2))
                .andExpect(jsonPath("$.subIdeas[0]").value("sub-idea-1"));
    }
    ...
    @Test
    @WithMockUser(authorities = "USER")
    public void createSubIdea_success() throws Exception {
        // given
        ...
        Idea createdSubIdea = new Idea();
        createdSubIdea.setIdeaId("sub-idea-id");
        createdSubIdea.setIdeaName("Sub Idea");
        createdSubIdea.setIdeaDescription("Sub Description");
        createdSubIdea.setProjectId(PROJECT_ID);
        createdSubIdea.setCreatedAt(LocalDateTime.now());
        createdSubIdea.setUpdatedAt(LocalDateTime.now());
        createdSubIdea.setIdeaStatus(IdeaStatus.OPEN);
        createdSubIdea.setUpVotes(0L);
        createdSubIdea.setDownVotes(0L);
        createdSubIdea.setSubIdeas(new ArrayList<>());

        when(ideaService.createSubIdea(eq(PROJECT_ID), eq(IDEA_ID), any(IdeaRegister.class), eq(AUTH_HEADER)))
            .thenReturn(createdSubIdea);

        // when/then
        mockMvc.perform(post("/projects/{projectId}/ideas/{ideaId}", PROJECT_ID, IDEA_ID)
                .header("Authorization", AUTH_HEADER)
                .contentType(MediaType.APPLICATION_JSON)
                .content(mapper.writeValueAsString(subIdeaRegister)))
                .andExpect(status().isCreated())
                .andExpect(jsonPath("$.ideaId").value("sub-idea-id"))
                .andExpect(jsonPath("$.ideaName").value("Sub Idea"))
                .andExpect(jsonPath("$.ideaDescription").value("Sub Description"))
                .andExpect(jsonPath("$.projectId").value(PROJECT_ID))
                .andExpect(jsonPath("$.ideaStatus").value("OPEN"))
                .andExpect(jsonPath("$.upVotes").value(0))
                .andExpect(jsonPath("$.downVotes").value(0));
    ...
    @Test
    @WithMockUser(authorities = "USER")
    public void createSubIdea_parentNotFound() throws Exception {
        // given
        IdeaRegister subIdeaRegister = new IdeaRegister();
        subIdeaRegister.setIdeaName("Sub Idea");
        subIdeaRegister.setIdeaDescription("Sub Description");
